    ...
    <tbody>
      <c:forEach var="cartVO" items="${list }">
        ...
        <tr> 
          ...
          <td style='vertical-align: middle; text-align: center;'>
            <input type='number' id='${cartno }_cnt' min='1' max='100' step='1' value="${cnt }"><br>
      ...
      <tr>
        ...
        <td style='width: 50%;'>
          ...
          <form name='frm' id='frm' style='margin-top: 50px;'>
            <button type='button' id='btn_ordering' class='btn btn-info' style='font-size: 1.5em;'>주문하기</button>
          </form>
        <td>
      </tr>
    </tbody>
